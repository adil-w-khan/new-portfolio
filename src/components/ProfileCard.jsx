...
export default function ProfileCard({ title, Icon, route, bg }) {
  return (
    <Link to={route}>
      <div className="group flex flex-col items-center cursor-pointer transition-transform duration-300">
        <div className={`w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-lg flex items-center justify-center ${bg} border-4 border-transparent group-hover:border-white transition`}>
